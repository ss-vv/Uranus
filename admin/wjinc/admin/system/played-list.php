		...
		<thead>
			<tr>
				<th colspan="9" style="text-align:left;">               	
					<span style="float:right; margin-right:20px"><a href="/admin778899.php/system/switchPlayedGroupStatus/<?=$group['id']?>" target="ajax" call="reloadPlayed"><?=$this->iff($group['enable'],'关闭','开启')?></a></span><span style="float:right; margin-right:20px"><a href="/admin778899.php/system/updateAll" onclick="plxg(this)" class="plxg btn btn-red" target="ajax" call="reloadPlayed">批量保存</a></span>
					<?=$group['name']?>&nbsp;&nbsp;&nbsp;&nbsp;
					<span class="spn1">[状态：<span class="state1"><?=$this->iff($group['enable'],'开启','关闭')?></span>]</span><div style="margin-left: 455px;margin-top:-20px">预设<input type="text" class="mzinput" style="margin-left: 20px"></div>                 
				</th>
			</tr>
		</thead>
		<tbody>
