...
if($para['type']==1){
	...
	$actionNo = 44*(strtotime(date('Y-m-d', $time))-strtotime('2019-02-20'))/3600/24+$para['actionNo']+729788-1;	
}elseif($para['type']==60){
	//广东快乐10分
	$time=strtotime($para['actionTime']);
	...
	//北京快乐8和PC蛋蛋
	$time=$this->time;
	$actionNo = 179*(strtotime(date('Y-m-d', $time))-strtotime('2019-02-20'))/3600/24+$para['actionNo']+936980-1;						
}elseif($para['type']==21){
	//广东11选五
	$time=strtotime($para['actionTime']);
	$actionNo=$para['actionNo'];
