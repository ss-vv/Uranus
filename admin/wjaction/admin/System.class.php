...
class System extends AdminBase{
	...
	public final function updateAll(){
		$data=array();
		$data['dataarr']=$_GET['dataarr'];
		$data['odds']=$_GET['odds'];
		$data['rebate']=$_GET['rebate'];
		$data['rebateDouble']=$_GET['rebate'];
		$data['oddsDouble']=$_GET['odds'];
		$data['minMoney']=$_GET['minMoney'];
		$data['maxMoney']=$_GET['maxMoney'];
		$data['maxTurnMoney']=$_GET['maxTurnMoney'];
		for($i=0;$i<count($data['dataarr']);$i++){
			$sql="update ssc_played set odds='".$data['odds'][$i]."',rebate='".$data['rebate'][$i]."',rebateDouble='".$data['rebate'][$i]."',oddsDouble='".$data['odds'][$i]."',minMoney='".$data['minMoney'][$i]."',maxMoney='".$data['maxMoney'][$i]."',maxTurnMoney='".$data['maxTurnMoney'][$i]."' where id='".$data['dataarr'][$i]."'";
