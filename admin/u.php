...
<meta name="keywords" content="PHP探针,PHP组件,UPUPW,apache,绿色服务器,php,ZendOptimizer,ionCube,memcache,XCache,SendMail" />
<meta name="description" content="UPUPW APACHE专用版PHP探针可检测ionCube,ZendOptimizer,memcache,XCache,和SendMail等PHP组件." />
...
<body>
<div class="head1"><a href="http://php.upupw.net" style="color:#ffffff" >{ UPUPW PHP 探针 }</a></div>
<div class="head2"></div>
...
<td class="fc"><?=function_exists('imap_close') ? YES : NO ?></td>
</tr>
<tr>
<td class="er">软件管理设置</td>
<td class="fl">
<a target="_blank" href='<?=htmlentities($_SERVER['PHP_SELF'])?>?act=phpinfo'>PHP详细信息</a> | <a target="_blank" href="/pmd/">phpMyAdmin管理</a>
</td>
...
<td colspan="2" class="ec" width="50%">PHP 缓存优化组件</td>
</tr>
<tr>
...
<tr>
<td class="fc"><?=defined('OPTIMIZER_VERSION') ? YES.' / '.OPTIMIZER_VERSION : NO?></td>
...
<tr>
<td colspan="8" class="ft">UPUPW <?=PHP_SAPI .' PHP/'.PHP_VERSION?>包含以上组件，不同PHP版本包含组件不同，请根据需要在UPUPW面板PHP功能选项开启</td>
</tr>
</table>
<table width="100%" class="inp">
<tr>
