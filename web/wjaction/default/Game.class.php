...
class Game extends WebLoginBase{
    ...
    public final function getListDatado(){
        $this->display('game/getTestData.php');
    }
    ...
    public final function jsssc(){
        $this->display('game/jsssc/index.php');
    }

    public final function jssscsol(){
        $this->display('game/jsssc/sol.php');
    }

    public final function jssschistory(){
        $this->display('game/jsssc/history.php');
    }
    ...
    public final function jspk10(){
        $this->display('game/jspk10/index.php');
    }

    public final function jspk10sol(){
        $this->display('game/jspk10/sol.php');
    }

    public final function jspk10com(){
        $this->display('game/jspk10/com.php');
    }

	public final function jspk10history(){
		$this->display('game/jspk10/history.php');
	}
