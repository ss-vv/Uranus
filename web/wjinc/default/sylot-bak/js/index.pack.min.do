...
var USER_LOGIN_PAGE = "/login.html";
...
var UserBet = {
    ...
    submitBet: function() {
        ...
        if (UserBet.isSub) {
            ...
            $.ajax({
                type: "POST",
                url: "/game/bet.do?t=" + Date.parse(new Date()),
                data: e,
                dataType: "json",
                success: function(g) {
                    setTimeout(function() {
    ...
    processCode: function(b, j) {
        ...
        if (UserBet.gameId == 50 || UserBet.gameId == 55|| UserBet.gameId == 72) {
            ...
            if (UserBet.gameId == 65) {
                ...
                if (UserBet.gameId == 1 || UserBet.gameId == 3) {
                    for (var e = 0; e < g.length; e++) {
                        a += '<span><b class="b' + g[e] + '"></b></span>'
                    }
                    k = "T_SSC L_CQSSC"
                } else {
                    if (UserBet.gameId == 60 || UserBet.gameId == 21) {
                        for (var e = 0; e < g.length; e++) {
                            a += '<span><b class="b' + g[e] + '"></b></span>'
                        }
                        k = "T_KLSF L_GDKLSF"
                            ...
                            if (UserBet.gameId == 61) {
                                ...
                                if (UserBet.gameId == 70) {
                                    ...
                                    if (UserBet.gameId == 66) {
                                        ...
                                        a += '<span style="margin:5px;5px;0px;0px; color:#000">总和：</span>';
        ...
        $("#result_balls").removeClass().addClass(k).html(a);
        $("#cur_turn_num").html(b)
    },
...
var UserInfos = {
    ...
    updatePw: function() {
        ...
        $.ajax({
            ...
            url: "/user/updateMyPwd.do?t=" + Date.parse(new Date()),
            success: function(e) {
                if (e) {
                    layer.alert("密码修改成功！",
                    function() {
