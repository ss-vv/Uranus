...
//					ShowNewPageInit();
        ...
        $.ajax({
            type:"get",
            url:staticFileUrl+"/data/HistoryLotteryLimit.js",
    ...
    formatData : function(gameId, data) {
        var htmlStr = "";
        if (gameId == 50||gameId == 55||gameId == 72 ||gameId == 56) {
            var formatStr = "<tr><td>{turnNum}</td><td><span class='ball c-n{n1}'></span></td><td><span class='ball c-n{n2}'></span></td><td><span class='ball c-n{n3}'></span></td><td><span class='ball c-n{n4}'></span></td><td><span class='ball c-n{n5}'></span></td><td><span class='ball c-n{n6}'></span></td><td><span class='ball c-n{n7}'></span></td><td><span class='ball c-n{n8}'></span></td><td><span class='ball c-n{n9}'></span></td><td><span class='ball c-n{n10}'></span></td></tr>";
            for ( var i in data) {
                var d = data[i];
                var gyh = d.n1 + d.n2;
            ...
            //var formatStr = "<tr><td>{turnNum}</td><td class='menu1' style='width:45px;'>{n1}</td><td class='menu1' style='width:45px;'>{n2}</td><td class='menu1' style='width:45px;'>{n3}</td><td class='menu1' style='width:45px;'>{n4}</td><td class='menu1' style='width:45px;'>{n5}</td></tr>";
			var formatStr = "<tr><td>{turnNum}</td><td class='menu1'>{n1}</td><td class='menu1'>{n2}</td><td class='menu1'>{n3}</td><td class='menu1'>{n4}</td><td class='menu1'>{n5}</td><td>{total}</td><td>{totalDx}</td><td>{totalDs}</td><td>{lh}</td></tr>";
            for ( var i in data) {
                var d = data[i];
            ...
            var formatStr = "<tr><td>{turnNum}</td><td>{n1}</td><td>{n2}</td><td>{n3}</td><td>{n4}</td><td>{n5}</td><td>{n6}</td><td>{n7}</td><td>{n8}</td></tr>";
            for ( var i in data) {
                var d = data[i];
            ...
            var formatStr = "<tr><td>{turnNum}</td><td>{n1}</td><td>{n2}</td><td>{n3}</td><td>{total}</td><td>{totalDx}</td></tr>";
            for ( var i in data) {
                var d = data[i];
            ...
            var formatStr = "<tr><td>{turnNum}</td><td>{n1}</td><td>{n2}</td><td>{n3}</td><td>{n4}</td><td>{n5}</td><td>{n6}</td><td>{n7}</td><td>{n8}</td><td>{n9}</td><td>{n10}</td><td>{n11}</td><td>{n12}</td><td>{n13}</td><td>{n14}</td><td>{n15}</td><td>{n16}</td><td>{n17}</td><td>{n18}</td><td>{n19}</td><td>{n20}</td></tr>";
            for ( var i in data) {
                var d = data[i];
                var total = d.n1 + d.n2 + d.n3 + d.n4 + d.n5 + d.n6 + d.n7
            ...
            var formatStr = "<tr><td>{turnNum}</td><td>{n1}</td><td>{n2}</td><td>{n3}</td><td>{n4}</td><td>{n5}</td></tr>";
            for ( var i in data) {
                var d = data[i];
                var total = d.n1 + d.n2 + d.n3 + d.n4 + d.n5;
                var totalDx = "小";
            ...
            var formatStr = "<tr><td>{turnNum}</td><td>{n1}</td><td>{n2}</td><td>{n3}</td><td>{total}</td><td>{totalDx}</td><td>{totalDs}</td><td>{totalJz}</td><td>{totalSb}</td></tr>";
            for ( var i in data) {
                var d = data[i];
                var total = d.n1 + d.n2 + d.n3;
                var totalDx = "小";
            ...
            var formatStr = "<tr><td>{turnNum}</td><td>{n1}</td><td>{n2}</td><td>{n3}</td><td>{n4}</td><td>{n5}</td><td>{n6}</td><td>{n7}</td></tr>";
            for ( var i in data) {
                var d = data[i];
                var total = d.n1 + d.n2 + d.n3 + d.n4 + d.n5 + d.n6 + d.n7;
                var totalDx = "总和小";
