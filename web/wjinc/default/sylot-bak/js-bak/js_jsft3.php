...
$sql="select * from {$this->prename}bets where type=56 and actionNo=? and isDelete=0 and lotteryNo=''";
$rows=$this->getRows($sql, $lastNo['actionNo']);
$LiRunLv=$this->getValue("select value from {$this->prename}params where name =?",'LiRunLv');
