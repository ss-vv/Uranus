...
<table width="100%" border="0" cellspacing="1" cellpadding="4" class='table_b'>
    ...
    <tr height=25 class='table_b_tr_b'>
      ...
      <td align="left" ><input name="fanDian" max="0" value=""  fanDianDiff=0 onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')"/><span style="color:#000; margin-left:10px;">0-0%</span></td> 
    </tr>
	<tr height=25 class='table_b_tr_b'>
