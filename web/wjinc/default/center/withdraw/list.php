...
<script type="text/javascript" src="/static/lib/jquery/page/jquery.pagination.js"></script>
	...
	<div class="memberinfo floatleft">
		...
		<div class="membersubnavi">
			...
			<div class="subnavi blue">
				提款记录<div class="subnaviarrow"></div>
			</div>
		</div>
		...
		<div class="search-bar">
			<ul>
				...
				<li>
					<button type="button" class="btn" onclick="WithDraw.getWithDrawList();">搜索</button>
				</li>
			</ul>
		</div>
			...
			<table class="table">
				<thead>
					<tr class="trcolor">
						...
						<th style="width: 6%">豆豆</th>
						<th style="width: 28%">交易描述</th>
						<th style="width: 12%">单据状态</th>
					</tr>
				</thead>
				<tbody id="withdrawlist-tbody"></tbody>
			</table>
		</div>
