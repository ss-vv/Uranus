...
<script type="text/javascript" src="/static/lib/util/error.js" async="async"></script>
	...
	<div class="memberinfo floatleft">
		...
		<div id="withdrawal1" class="subcontent1 margintop20">
			<!-- <p class="bigtxt aligncenter gray">修改登录密码</p> -->
			<div class="formpanel">
				<div class="wd-row">
				...
				<div class="wd-row" style="text-align: center;">
					<input type="button" class="c-button" onclick="User.updatePwd();" value="提交">
				</div>
			</div>
		</div>
	</div>
