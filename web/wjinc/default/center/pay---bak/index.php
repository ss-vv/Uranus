	...
	<div class="memberinfo floatleft">
		...
		<div class="steps">
			...
			<div class="tabs">
                ...
                <?php }?>
                <?php if (isset($this->bankList['onlinePayment'])) {?>
				<div class="tab hide" id="tp_sf_zfb" payval="onlinePayment" title="sfzfb"><?=$this->bankList['onlinePayment']['name']?></div>
                <?php }?>
                <?php if (isset($this->bankList['onlinePayment'])) {?>
				...
				<div class="tab hide" id="tp_wx" payval="weixin" onclick="Pay.initWeChat(this);"><?=$this->bankList['weixin']['name']?></div>
                <?php }?>
                <?php if (isset($this->bankList['alipay'])) {?>
				<div class="tab hide" id="tp_zfb" payval="alipay" onclick="Pay.initAWRechCfg(this);"><?=$this->bankList['alipay']['name']?></div>
                <?php }?>
                <?php if (isset($this->bankList['cft'])) {?>
				<div class="tab hide" id="tp_cft" payval="cft" onclick="Pay.initCft(this);"><?=$this->bankList['cft']['name']?></div>
                <?php }?>
			</div>
		</div>
