...
<script type="text/javascript" src="/static/lib/util/error.js" async="async"></script>
	...
	<div class="memberinfo floatleft">
		...
		<div class="gap5"></div>
		<p>988彩票网投领导者·实力铸就品牌·诚信打造一切·相信品牌的力量</p>
		...
		<div class="steps">
			...
			<div class="tabs">
				...
				<div class="tab hide" id="tp_cft" payval="cft" onclick="Pay.initCft(this);">工商银行转账</div>
			</div>
		</div>
				...
				<div class="subrow">
					...
					<div  class="subcol2">
						<div id="sfwx-subcol" class="banklist marginbtm10">
							<input class="bankradiobtn" type="radio" id="758" name="payId" value="992" code="ZFB" checked="checked" id="sfzfb_radio">
							<i class="ico-zfb"></i>
		...
		<div class="subcontent" style="display: none" id="subpagetp_sf_wx">
			<form id="sf_online_pay_form" method="post" onsubmit="return Pay.onlinePay('sf_wx');" target="_blank" action="/userrech/onlinePay.do">
				...
				<div class="subrow">
					...
					<div  class="subcol2">
						<div id="sfwx-subcol" class="banklist marginbtm10">
							<input class="bankradiobtn" type="radio" id="57" name="payId" value="1004" code="WEIXIN" checked="checked" id="sfwx_radio">
