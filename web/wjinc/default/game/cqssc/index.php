						    ...
						    <div class="cont-col3-bd" id="bet_tab"> 
						     <table class="u-table2 play_tab_1">
						      ...
						      <tbody> 
							   ...
							   <tr> 
						        <td id="play_name_1108" class="name">总和大单</td> 
						        <td id="play_odds_1108" class="odds"><span class="c-txt3">--</span></td> 
						        <td id="play_text_1108" class="amount"><input type="text" /></td> 
						        
						        <td id="play_name_1109" class="name">总和小单</td> 
						        <td id="play_odds_1109" class="odds"><span class="c-txt3">--</span></td> 
						        <td id="play_text_1109" class="amount"><input type="text" /></td>
						         
						        <td id="play_name_1110" class="name">总和大双</td> 
						        <td id="play_odds_1110" class="odds"><span class="c-txt3">--</span></td> 
						        <td id="play_text_1110" class="amount"><input type="text" /></td>
						         
						        <td id="play_name_1111" class="name">总和小双</td> 
						        <td id="play_odds_1111" class="odds"><span class="c-txt3">--</span></td> 
						        <td id="play_text_1111" class="amount"><input type="text" /></td> 
						       </tr> 
						       <tr> 
...
<div class="count-wrap">
	...
	<table class="u-table2 mt5">
		<thead>
			<tr id="stat_type">
				<th class="u-tb3-th2 " id="stat_nums_btn" type="nums"
				...
				<th class="u-tb3-th2 select" id="stat_zhdx_btn" type="zhdx"
	...
	<table class="u-table4 table-td-valign-top">
		<tbody>
			...
			<tr id="qiu1_zhdx" class="stattd "></tr>
