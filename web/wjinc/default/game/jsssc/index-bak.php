      ...
      <a href="javascript:parent.UserBet.resetData()" class="u-btn1">重置</a> 
						    ...
						    <div class="cont-col3-bd" id="bet_tab"> 
						     ...
						     <table class="cont-list1 hide">
						     	...
						     	<!-- 前三中三后三 -->
	<table class="u-table2 play_tab_7 hide" style="margin-top: 10px;" > 
      <thead> 
       <tr> 
        <th colspan="15">前三</th> 
       </tr> 
     ...
     <table class="u-table2 play_tab_8 hide" style="margin-top: 10px;"> 
      <thead> 
       <tr> 
        <th colspan="15">中三</th> 
       </tr> 
     ...
     <table class="u-table2 play_tab_9 hide" style="margin-top: 10px;" > 
      <thead> 
       <tr> 
        <th colspan="15">后三</th> 
       </tr> 
...
<div class="count-wrap">
	...
	<table class="u-table4 table-td-valign-top">
		<tbody>
			...
			<tr id="qiu1_zhdx" class="stattd "><strong style="color:red">从左往右</strong></tr>
...
<script type="text/javascript" src="/static/js/lottery/jsssc/stat.js" async="async"></script>
