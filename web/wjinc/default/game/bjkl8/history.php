...
function initGameSelect(obj){
  ...
  <div id="subpage" class="cp-box2" style="width: 1000px"> 
    <div style="padding: 5px 0px;">
	<select id="historyQueryParamGameId" onchange="historyDateChange()">
        <option value="50">北京赛车PK10</option>
        <option value="72">快速赛车</option>
        <option value="73">快速时时彩</option>
        <option value="74">快速六合彩</option>
