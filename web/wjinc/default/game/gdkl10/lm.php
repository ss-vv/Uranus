    ...
    <div class="cont-col3-bd" id="bet_tab"> 
     ...
     <table class="u-table2 mt10 play_tab_lm_checkbox_84 K3Term"> 
      ...
      <tbody id="lm_checkboxs"> 
       <tr> 
        <td class="name not-event"><span class="ball c-b1">01</span></td> 
        <td class="checkbox_td">
        	<input type="checkbox" value="1" />
        </td> 
        <td class="name not-event"><span class="ball c-b1">06</span></td> 
        <td class="checkbox_td">
        ...
        <td class="name not-event"><span class="ball c-b1">16</span></td> 
        <td class="checkbox_td">
        	<input type="checkbox" value="16" />
        </td> 
       </tr> 
       <tr> 
        <td class="name not-event"><span class="ball c-b1">02</span></td> 
        <td class="checkbox_td">
        	<input type="checkbox" value="2" />
        </td> 
        <td class="name not-event"><span class="ball c-b1">07</span></td> 
        <td class="checkbox_td">
        	<input type="checkbox" value="7" />
        </td> 
        <td class="name not-event"><span class="ball c-b1">12</span></td> 
        <td class="checkbox_td">
        	<input type="checkbox" value="12" />
        </td> 
        <td class="name not-event"><span class="ball c-b1">17</span></td> 
        <td class="checkbox_td">
        	<input type="checkbox" value="17" />
        </td> 
       </tr> 
       <tr> 
        <td class="name not-event"><span class="ball c-b1">03</span></td> 
        <td class="checkbox_td">
        	<input type="checkbox" value="3" />
        </td> 
        <td class="name not-event"><span class="ball c-b1">08</span></td> 
        <td class="checkbox_td">
        	<input type="checkbox" value="8" />
        </td> 
        <td class="name not-event"><span class="ball c-b1">13</span></td> 
        <td class="checkbox_td">
        	<input type="checkbox" value="13" />
        </td> 
        <td class="name not-event"><span class="ball c-b1">18</span></td> 
        <td class="checkbox_td">
        	<input type="checkbox" value="18" />
        </td> 
       </tr> 
       <tr> 
        <td class="name not-event"><span class="ball c-b1">04</span></td> 
        <td class="checkbox_td">
        	<input type="checkbox" value="4" />
        </td> 
        <td class="name not-event"><span class="ball c-b1">09</span></td> 
        <td class="checkbox_td">
        	<input type="checkbox" value="9" />
        </td> 
        <td class="name not-event"><span class="ball c-b1">14</span></td> 
        <td class="checkbox_td">
        	<input type="checkbox" value="14" />
        </td> 
        <td class="name not-event"><span class="ball c-b1">19</span></td> 
        <td class="checkbox_td">
        	<input type="checkbox" value="19" />
        </td> 
       </tr> 
       <tr> 
        <td class="name not-event"><span class="ball c-b1">05</span></td> 
        <td class="checkbox_td">
        ...
        <td class="name not-event"><span class="ball c-b1">15</span></td> 
        <td class="checkbox_td">
        	<input type="checkbox" value="15" />
        </td> 
        <td class="name not-event"><span class="ball c-b1">20</span></td> 
        <td class="checkbox_td">
