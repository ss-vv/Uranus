...
<!--       <label> <input type="checkbox" class="u-cb1" /> 预设 </label>  -->
    ...
    <table class="u-table2 play_tab_80 K3Term"> 
      <thead> 
       <tr> 
      ...
      <tbody> 
       ...
       <tr> 
        <td id="play_name_608029" class="name">东</td> 
        <td id="play_odds_608029" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_608029" class="amount"><input type="text" /></td> 
        
        <td id="play_name_608030" class="name">南</td> 
        <td id="play_odds_608030" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_608030" class="amount"><input type="text" /></td>
         
        <td id="play_name_608031" class="name">西</td> 
        <td id="play_odds_608031" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_608031" class="amount"><input type="text" /></td>
         
        <td id="play_name_608032" class="name">北</td> 
        <td id="play_odds_608032" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_608032" class="amount"><input type="text" /></td>
       </tr>
        
       <tr> 
        <td id="play_name_608033" class="name">中</td> 
        <td id="play_odds_608033" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_608033" class="amount"><input type="text" /></td> 
        
        <td id="play_name_608034" class="name">发</td> 
        <td id="play_odds_608034" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_608034" class="amount"><input type="text" /></td>
         
        <td id="play_name_608035" class="name">白</td> 
        <td id="play_odds_608035" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_608035" class="amount"><input type="text" /></td>
