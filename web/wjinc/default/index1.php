...
<link href="static/css/index.pack.min.css?v=169" rel="stylesheet"/>

<script type="text/javascript" src="/static/lib/jquery/jquery-1.11.2.min.js"></script>
<script type="text/javascript" src="/static/lib/layer/layer.js"></script>
<script type="text/javascript" src='/config/config.js'></script>

<script type="text/javascript" src="/static/js/index.pack.min.js?v=1708"></script>
...
<div class="main-body">
    <div class="header">
        ...
        <div class="trial-cls menu4"><a href="http://api.pop800.com/chat/361580" target="_blank" class="support"></a></div>
        <div class="menu3"><a href="javascript:logout();" class="logout"></a></div>
        <div style="clear:both;"></div>
        <div class="lotterys">
            <div class="show" id="homeMenus"></div>
        ...
        <div class="sub" id="homeCateMenus">
			...
			<div id="cate_menus_56" class="show cate_menu">
                <a class="selected" href="/game/jsft/index.html" onclick="HomeMenu.selCateMenuClass(this);"
                   target="framePage" cate_id="1">两面盘</a>
                |
            ...
            <div id="cate_menus_74" class="hide cate_menu">
                <a class="selected" href="/game/jslhc/index.html" onclick="HomeMenu.selCateMenuClass(this);"
                   target="framePage" cate_id="85">特码</a>
                |
                ...
                |
                <a href="/game/jslhc/zm16.html" onclick="HomeMenu.selCateMenuClass(this);" target="framePage"
                   cate_id="93">正码1~6</a>
                |
                <a href="/game/jslhc/ptyxws.html" onclick="HomeMenu.selCateMenuClass(this);" target="framePage"
                   cate_id="95">平特一肖尾数</a>
                |
                ...
                |
                <a href="/game/jslhc/zhongxiao.html" onclick="HomeMenu.selCateMenuClass(this);" target="framePage"
                   cate_id="97">总肖</a>
                |
                <a href="/game/jslhc/zxbz.html" onclick="HomeMenu.selCateMenuClass(this);" target="framePage"
                   cate_id="98">自选不中</a>
                |
                <a href="/game/jslhc/lxlw.html" onclick="HomeMenu.selCateMenuClass(this);" target="framePage"
                   cate_id="99">连肖连尾</a>
                |
    ...
    <div class="main clearfix">
        ...
        <div class="siderbar" id="left_main">
            <div class="side_left">
                ...
                <div class="sider-col1">
                    <div class="info"><label>账号：</label><span id="userinfo_name">加载中</span>
                        <script type="text/javascript">$("#userinfo_name").html(user.userName);</script>
                    </div>
                    <div class="info"><label>豆豆余额：</label><span id="userinfo_money" class="balance">加载中</span></div>
                    <div class="info">
                        <label>未结豆豆：</label><span id="userinfo_unbalancedMoney" class="betting">加载中</span>
                ...
                <div class="title trial-cls"><a href="/center/user/loginpwd.html" target="framePage"
                                                style="padding-left: 55px;">个人中心
                        <div style="width: 56px;float:right;" align="left">&nbsp;
                            <img alt="点击刷新消息" src="/static/images/msg_new2.png" id="left_user_new_notice"
                                 title="您有新的消息">
                        </div>
                    </a>
                </div>
        ...
        <!--content-->
        <div class="content">
            <iframe id="framePage" name="framePage" src="" width="100%" height="300px"
...
<div class="popPanel" style="display: none">
