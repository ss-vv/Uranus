...
var HomeMenu = {
    ...
    init: function () {
        ...
        var k1 = '<a href="javascript:HomeMenu.selMenuClass({gameId});" gameid="{gameId}" class="{selClass}" style="display: none;"><span>{gameName}</span>{icon}</a>';
        var j = "";
        var j1 = "";
        var a = 0;
        var count=0;
...
var RequestIssue = {
        ...
        $.ajax({
            ...
            success: function (b) {
                if (b) {
                    ...
                    if ((a != b.issue) ||(b.gameId==56 || b.gameId==72 || b.gameId==73 || b.gameId==74)) {
    ...
    processCode: function (b, j) {
        ...
        var a = "";
        var k = "";
        if (UserBet.gameId == 50 || UserBet.gameId == 55 || UserBet.gameId == 72 || UserBet.gameId == 56) {
            for (var e in g) {
        ...
        $.ajax({
            ...
            success: function (b) {
                ...
                if (b && b.issue) {
                    ...
                    if (UserBet.gameId == 70 && b.issue == b.preIssue||UserBet.gameId == 74 && b.issue == b.preIssue) {
                        UserBet.isStop = true;
                        UserBet.stopBet();
...
function isThere(a) {
    if (a <= 0) {
        ...
        if (UserBet.gameId == 70||UserBet.gameId == 74) {
            ...
            if (UserBet.gameId != 70 && a > 20 * 60||UserBet.gameId != 74 && a > 20 * 60) {
                return true
            } else {
                return false
            }
