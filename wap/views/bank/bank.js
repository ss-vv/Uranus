...
//					console.log(obj);
				...
				for(var i in onlineData) {
					...
					if(obj.onlineType == 2) {
						...
						alipayOnlineList.push({id: obj.id, order: (alipayOnlineList.length + 1), onlineType: obj.onlineType, payCode: '1006', domain:obj.domain});
					}
					else if (obj.onlineType == 7) {// 微信在线支付 - 闪付
						weixinOnlinePayList.push({id: obj.id, order: (weixinOnlinePayList.length + 1), onlineType: obj.onlineType, payCode: '1007', domain:obj.domain});
					}
